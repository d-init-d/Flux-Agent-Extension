...
Status summary: `P-01a`, `P-01b`, `P-01c`, `P-02a`, `P-02b`, `P-02c`, `P-02d`, `P-03a`, `P-03b`, `P-03c`, `P-05a`, `P-05b`, and `P-06b` are complete; `P-01`, `P-02`, `P-03`, and `P-06` remain in progress pending their final targets.
...
- [x] `P-03a` Prompt injection pen-test
