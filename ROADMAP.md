...
| OA-02 - Multi-auth provider surface redesign                          | TODO   | -                                                                                                                                                             | Evolve registry/types so one provider can expose multiple auth options without overloading the current single-auth assumptions                                                             |
| OA-03 - Browser helper/deep-link auth contract                        | TODO   | -                                                                                                                                                             | Define the helper launch, callback/deep-link payload, trust boundary, and user-visible states for browser login                                                                            |
| OA-04 - Vault and message-surface expansion                           | TODO   | -                                                                                                                                                             | Add storage/message contracts for OpenAI browser-account state without exposing raw tokens to the UI                                                                                       |
| OA-05 - Unified OpenAI runtime auth coordinator                       | TODO   | -                                                                                                                                                             | Resolve `openai + api-key` vs `openai + browser-account` in one background-owned runtime path                                                                                              |
| OA-06 - Options/OpenAI auth-choice UX                                 | TODO   | -                                                                                                                                                             | Replace the current provider-only setup with `Login method` controls under `OpenAI`                                                                                                        |
| OA-07 - Model catalog and routing policy                              | TODO   | -                                                                                                                                                             | Show models based on auth method and route account-backed models through the account-backed runtime path                                                                                   |
| OA-08 - Legacy Codex migration bridge                                 | TODO   | -                                                                                                                                                             | Preserve current `codex` users by mapping stored state to `openai + browser-account` without breaking old vault data                                                                       |
| OA-09 - Popup/sidepanel/onboarding alignment plus regression coverage | TODO   | -                                                                                                                                                             | Make all surfaces readiness-aware for both OpenAI auth methods and extend tests accordingly                                                                                                |
