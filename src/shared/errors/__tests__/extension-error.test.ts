...
describe('ExtensionError', () => {
  ...
  describe('error codes', () => {
    const codeMessagePairs: Array<[ErrorCode, string]> = [
      ...
      [ErrorCode.FILE_UPLOAD_INVALID, 'Invalid file upload'],
      [ErrorCode.FILE_UPLOAD_NOT_FOUND, 'File upload not found'],
      [ErrorCode.FILE_UPLOAD_LIMIT_EXCEEDED, 'File upload limit exceeded'],
